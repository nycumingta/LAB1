...
parser.add_argument('--dataset', type=str, choices=['cifar10', 'lab1'], help='Choose between lab1')
...
def main():
  ...
  if args.dataset == 'lab1':
    # 讀取訓練資料夾
    train_data = datasets.ImageFolder(args.data_path, transform=train_transform)
    # 讀取測試資料夾
    test_data = datasets.ImageFolder(args.data_path, transform=test_transform)
    num_classes = 2
  elif args.dataset == 'cifar100':
